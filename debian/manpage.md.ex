...
rbw - program to do something

# SYNOPSIS

**rbw** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**rbw** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **rbw** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**rbw** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    rbw. See **foo.conf**(5) for further details.
...
**rbw** provides some return codes, that can be used in scripts:
...
e. alvarez <eax@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 e. alvarez
